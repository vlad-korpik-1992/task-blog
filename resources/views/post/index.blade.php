...
@section('content')
    <div class="manager__box__items">
        ...
        <div class="manager__box__items__effect manager__box__items__effect--end">
            <a href="{{ route('post.create') }}" class="effect__link">
        ...
        <div class="manager__box__items__table">
            <table class="crop__box">
                ...
                <tr class="crop__box__head">
                    ...
                    <th class="crop__box__head__items">Категория</th>
                ...
                @foreach ($posts as $post)
                    <tr class="crop__box__head">
                        ...
                        <td class="crop__box__head__items" data-title="Категория">{{ $post->category->title }}</td>
            ...
            <div class="programme__box">
                <div class="programme__box__items">{{ $posts->links() }}</div>
            </div>
        </div>
    </div>
@endsection
